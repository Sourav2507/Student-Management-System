      ...
      <main className="flex-1 bg-gray-50 p-8 overflow-y-auto">
        ...
        <div className="space-y-4 mb-6">
          {exams.map((exam) => (
            <div
              key={exam._id}
              className="border border-blue-500 p-4 rounded-xl bg-white shadow-sm relative"
            >
              <button
              ...
              <p className="text-sm text-gray-600">
                ...
                {exam.startTime || "N/A"} - {exam.endTime || "N/A"} •
                {exam.duration} • {exam.totalMarks} Marks
              </p>
        ...
        {showForm && (
          <div className="bg-white border border-gray-200 p-6 rounded-xl shadow-sm">
            ...
            <div className="mt-6 space-y-4">
                  ...
                  {q.options.map((opt, oi) => (
                    <div key={oi} className="flex items-center gap-2 mb-2">
                      ...
                      <input
                        ...
                        onChange={() =>
                          handleQuestionChange(qi, "correctOption", oi)
                        }
                      />
                    </div>
                  ))}
              ...
              <button onClick={addQuestion} className="text-sm text-blue-600">
